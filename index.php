  ...
  <section class="relative py-16 bg-slate-900 text-center overflow-hidden">
    ...
    <div class="relative z-10">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 px-6 md:px-10">
        <img src="https://thf.bing.com/th?q=Online+Book+Store+Static+Web+Page&w=600&h=400" class="rounded-lg shadow-lg w-full h-64 object-cover" alt="Book Store 1"/>
        <img src="https://thf.bing.com/th/id/OIP.fA5hsVpFKFzWoqKM-qeXcQHaEo?w=600&h=400" class="rounded-lg shadow-lg w-full h-64 object-cover" alt="Book Store 2"/>
        <img src="https://www.roadaffair.com/wp-content/uploads/2020/11/arc-n-book-seoul-south-korea-visitkorea-1024x683.jpg" class="rounded-lg shadow-lg w-full h-64 object-cover" alt="Book Store 3"/>
      </div>
    </div>
  </section>
